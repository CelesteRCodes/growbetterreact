    ...
    <div className="new-plant-form" align="center">
      <form action="/">
        <div className="entry-form">
          ...
          <br />
          <label>
            <strong>Nutrient Type Given?</strong>
          </label>
          <br />
          <input
            name="nute_type"
            type="text"
            placeholder="Name of Nutrient/Type"
          />
          <br />
          <br />
          <label>
          ...
          <input
            name="comment"
            type="text"
            placeholder="How are the leaves looking?"
          />
          <br />
          <br />
          <label>
          ...
          <br />
          <input type="file" name="new-entry-upload" id="new-entry-upload" />
          <br />
          <br />
